    ...
    render() {
        ...
        return (
            ...
            <View style={this.props.containerStyle}>
                ...
                {countDown.min > 0 ? <Text style={this.props.minsStyle}>{this.leadingZeros(countDown.min)}</Text> : null}
                {countDown.min > 0 ? <Text style={this.props.secondColonStyle}>{this.props.mins}</Text> : null}
                ...
                {/* <Text style={this.props.secsStyle}>{this.leadingZeros(countDown.sec)}</Text>
                <Text style={this.props.secondColonStyle}>秒</Text> */}
            </View>
