...
describe('测试StringUtil', function(){
  ...
  it('should well build url with params if params need encode', function() {
    return StringUtil.buildUrlWithParams('http://www.baidu.com/?s=1', {b:'/^(http).+jhProduction-release.+(.apk)$/'}).toLowerCase()
      .should.to.equal('http://www.baidu.com/?s=1&b=%2f%5e(http).%2bjhProduction-release.%2b(.apk)%24%2f'.toLowerCase());
  });
});
